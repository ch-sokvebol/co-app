...
class IRRCaculatorScreen extends StatefulWidget {
  @override
  _IRRCaculatorScreenState createState() => _IRRCaculatorScreenState();
}

class _IRRCaculatorScreenState extends State<IRRCaculatorScreen> {
  void initState() {
    super.initState();
...
// grossDisbursementAmounttGlobalKey
  ...
  //
  final GlobalKey<ScaffoldState> scaffoldKeyIRR =
                          ...
                          childs: FormBuilderTextField(
                            ...
                            onChanged: (e) {
                              if (mounted) {
                                ...
                                dynamic amountDocble = double.tryParse(e!);
                                ...
                                convertCurrency(e);
                                //  var amountInt = int.tryParse(e);
                                paresAmountNumberDefault = int.tryParse(e);
                                if (mounted)
                                  setState(() {
                                    currencyAmountDouble = double.tryParse(e);
                                    storeAmount = int.tryParse(e) ?? 0;
                        ...
                        GroupFromBuilder(
                          ...
                          childs: FormBuilderTextField(
                            ...
                            onChanged: (dynamic e) {
                              ...
                              if (mounted) {
                                var irrParse = double.parse(e);
                                var amount = int.parse(amountDefault ?? 0);
                                ...
                                debugPrint(
                                    "---subFirst-------:$subFirstIncome");
                                // debugPrint("---parsed-------:$parsedIncome");
                                debugPrint(
                                    "---second-------:$secondIncomeDefault");
                                debugPrint("---final-------:$finalIncome");
                                setState(
                                  () {
                          ...
                          slivers: <Widget>[
                            ...
                            SliverList(
                              delegate: SliverChildBuilderDelegate(
                                ...
                                childCount:
                                    data.isNotEmpty ? data.length : [0].length,
                              ),
                            ),
                          ],
                        ),
