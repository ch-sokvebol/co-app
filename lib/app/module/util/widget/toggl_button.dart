...
class _ToggleButtonState extends State<ToggleButton> {
  ...
  late Color leftDescriptionColor;
  ...
  void initState() {
    ...
    leftDescriptionColor = widget.activeTextColor;
            ...
            onTap: () {
              setState(
                () {
                  ...
                  leftDescriptionColor = widget.inactiveTextColor;
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: _rightDescriptionColor),
                ),
              ),
            ),
          ),
