...
// grossDisbursementAmounttGlobalKey
  ...
  sumFinalIRR() {
    ...
    setState(() {
      finalSumAmount = sum;
      debugPrint("finalSumAmount:$finalSumAmount");
    });
  }
  ...
  calculeFinalIRR() {
    setState(
      () {
        ...
        debugPrint("finalSumIRR: $finalSumIRR");
        debugPrint("finalSumIncome: $finalSumIncome");
        debugPrint("finalSumAmount: $finalSumAmount");
      },
    );
  }
