...
class _NotificationState extends State<NotificationScreen> {
  ...
  Future onTapsDetail(values) async {
    ...
    await NotificationProvider().postNotificationRead(values['id']).then(
          (value) => {
            setState(() {
              _isLoading = false;
            }),
  ...
  Future loadMore(_pageSize, _pageNumber) async {
    ...
    try {
      ...
      debugPrint("lethng old====:${listMessages.lenth}");
    } catch (error) {
      ...
      child: isLoading
          ...
          : Scaffold(
              appBar: AppBar(
                ...
                //       width: 100.0,
                //       height: 40.0,
                //       toggleBackgroundColor: Colors.grey,
                //       toggleBorderColor: (Colors.white),
                //       toggleColor: (logoDarkBlue),
                //       activeTextColor: Colors.white,
                //       inactiveTextColor: Colors.black,
                //       leftDescription: 'All',
                //       rightDescription: 'Unread',
                //       onLeftToggleActive: () {
